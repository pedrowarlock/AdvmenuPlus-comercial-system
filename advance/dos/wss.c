...
static AC97_DEVICE_LIST intel_ich_dev_list[] = {
	{ 0x8086, 0x2415, PCI_ANY_ID, PCI_ANY_ID, DEVICE_INTEL, "Intel 82801AA (ICH) AC97 audio" },
	{ 0x8086, 0x2425, PCI_ANY_ID, PCI_ANY_ID, DEVICE_INTEL, "Intel 82901AB (ICH0) AC97 audio" },
	{ 0x8086, 0x2445, PCI_ANY_ID, PCI_ANY_ID, DEVICE_INTEL, "Intel 82801BA/M (ICH2) AC97 audio" },
	{ 0x8086, 0x2485, PCI_ANY_ID, PCI_ANY_ID, DEVICE_INTEL, "Intel 82801CA/M (ICH3) AC97 audio"	},
	{ 0x8086, 0x24c5, PCI_ANY_ID, PCI_ANY_ID, DEVICE_INTEL, "Intel 82801DB (ICH4) AC97 audio" },
	{ 0x8086, 0x7195, PCI_ANY_ID, PCI_ANY_ID, DEVICE_INTEL, "Intel 82440MX/82443MX AC97 audio" },
	{ 0x1039, 0x7012, PCI_ANY_ID, PCI_ANY_ID, DEVICE_SIS,	"SiS SI7012 AC97 audio" },
	{ 0x10de, 0x01b1, PCI_ANY_ID, PCI_ANY_ID, DEVICE_INTEL, "NVIDIA NFORCE (MCP) AC97 audio" },
	{ 0x1022, 0x764d, PCI_ANY_ID, PCI_ANY_ID, DEVICE_INTEL, "AMD AMD8111 AC97 audio" },
	{ 0x1022, 0x7445, PCI_ANY_ID, PCI_ANY_ID, DEVICE_INTEL, "AMD AMD768 AC97 audio" },
	
	{ 0x8086, 0x24d5, PCI_ANY_ID, PCI_ANY_ID, DEVICE_INTEL, "Intel 82801EB/ER (ICH5) AC97 audio" },
	{ 0x8086, 0x266e, PCI_ANY_ID, PCI_ANY_ID, DEVICE_INTEL, "Intel 82801FB/FR/FW/FRW (ICH6) AC97 audio" },
	{ 0x8086, 0x27de, PCI_ANY_ID, PCI_ANY_ID, DEVICE_INTEL, "Intel unknown (ICH7) AC97 audio" },
	{ 0x8086, 0x25a6, PCI_ANY_ID, PCI_ANY_ID, DEVICE_INTEL, "Intel unknown (ESB5) AC97 audio" },
	{ 0x8086, 0x2698, PCI_ANY_ID, PCI_ANY_ID, DEVICE_INTEL, "Intel unknown (ESB2) AC97 audio" },
	
	{ 0x10de, 0x003a, PCI_ANY_ID, PCI_ANY_ID, DEVICE_INTEL, "NVIDIA unknown (MCP04) AC97 audio" },
	{ 0x10de, 0x006a, PCI_ANY_ID, PCI_ANY_ID, DEVICE_INTEL, "NVIDIA nForce 2 (MCP2) AC97 audio" },
	{ 0x10de, 0x0059, PCI_ANY_ID, PCI_ANY_ID, DEVICE_INTEL, "NVIDIA unknown (CK804) AC97 audio" },
	{ 0x10de, 0x008a, PCI_ANY_ID, PCI_ANY_ID, DEVICE_INTEL, "NVIDIA unknown (CK8) AC97 audio" },
	{ 0x10de, 0x00da, PCI_ANY_ID, PCI_ANY_ID, DEVICE_INTEL, "NVIDIA nForce 3 (MCP3) AC97 audio" },
	{ 0x10de, 0x00ea, PCI_ANY_ID, PCI_ANY_ID, DEVICE_INTEL, "NVIDIA unknown (CK8S) AC97 audio" },
	{ 0x10de, 0x026b, PCI_ANY_ID, PCI_ANY_ID, DEVICE_INTEL, "NVIDIA unknown (MCP51) AC97 audio" },
